...
#define PROF_VPINFO_START INSTR_PROF_SECT_START(INSTR_PROF_VINFO_COMMON)
#define PROF_VPINFO_STOP INSTR_PROF_SECT_STOP(INSTR_PROF_VINFO_COMMON)
...
extern ValueProfInfo PROF_VPINFO_START COMPILER_RT_VISIBILITY COMPILER_RT_WEAK;
extern ValueProfInfo PROF_VPINFO_STOP COMPILER_RT_VISIBILITY COMPILER_RT_WEAK;
