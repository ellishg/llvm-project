...
private:
  ...
  /// Compute the address of the probe value that this profiling instruction
  /// acts on.
  Value *getProbeAddress(InstrProfCFGBase *I);

  /// Get the region counters for an increment, creating them if necessary.
  ///
  /// If the counter array doesn't yet exist, the profile data variables
  /// referring to them will also be created.
  GlobalVariable *getOrCreateRegionCounters(InstrProfCFGBase *Inc);
