...
; DYNAMIC-NOT: @__profvp_foo
; STATIC:     @__profvp_foo =
; STATIC-SAME:  [1 x i64] zeroinitializer
; STATIC-SAME:  section "__llvm_prf_vals"

; LOWER:      @__profvinfo_foo =
; STATIC-SAME:  ptr @__profvp_foo
; DYNAMIC-SAME: ptr null
; LOWER-SAME:   [3 x i16] [i16 1, i16 0, i16 0]
; LOWER-SAME:   section "__llvm_prf_vinfo"

; LOWER:      @__profd_foo =
; LOWER-SAME:   ptr @__profc_foo
; LOWER-SAME:   i64 sub (i64 ptrtoint (ptr @__profvinfo_foo to i64), i64 ptrtoint (ptr @__profd_foo to i64))
; TODO: Remove NumValueSites from data
; LOWER-SAME:   [3 x i16] [i16 1, i16 0, i16 0]
...
; LOWER: call void @__llvm_profile_instrument_target(i64 %1, ptr @__profvinfo_foo, i32 0)
  call void %tmp()
  ret void
}
...
; LOWER: call void @__llvm_profile_instrument_target(i64 %1, ptr @__profvinfo_vp_inline.[[#]], i32 0)
  call void %tmp()
  ret void
}
