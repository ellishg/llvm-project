...
; SAMPLE-VAR: @__profd_f = private global { i64, i64, i64, i64, i64, ptr, i64, i32, [3 x i16], i16, i32 } { i64 -3706093650706652785, i64 12884901887, i64 sub (i64 ptrtoint (ptr @__profc_f to i64), i64 ptrtoint (ptr @__profd_f to i64)), i64 0, i64 0, ptr @f.local, i64 sub (i64 ptrtoint (ptr @__profvinfo_f to i64), i64 ptrtoint (ptr @__profd_f to i64)), i32 1, [3 x i16] zeroinitializer, i16 0, i32 0 }, section "__llvm_prf_data", comdat($__profc_f), align 8
; SAMPLE-VAR: @__llvm_prf_nm = private constant {{.*}}, section "__llvm_prf_names", align 1
; SAMPLE-VAR: @llvm.compiler.used = appending global [3 x ptr] [ptr @__llvm_profile_sampling, ptr @__profd_f, ptr @__profvinfo_f], section "llvm.metadata"
